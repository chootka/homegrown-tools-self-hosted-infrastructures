...
(File is in [`starter-code/index_docs.py`](https://github.com/chootka/homegrown-tools-self-hosted-infrastructures/blob/main/week7-9/starter-code/index_docs.py))
...
(File is in [`starter-code/rag.py`](https://github.com/chootka/homegrown-tools-self-hosted-infrastructures/blob/main/week7-9/starter-code/rag.py))
...
(File is in [`starter-code/index_files.py`](https://github.com/chootka/homegrown-tools-self-hosted-infrastructures/blob/main/week7-9/starter-code/index_files.py))
...
(File is in [`starter-code/knowledge_base.py`](https://github.com/chootka/homegrown-tools-self-hosted-infrastructures/blob/main/week7-9/starter-code/knowledge_base.py))
